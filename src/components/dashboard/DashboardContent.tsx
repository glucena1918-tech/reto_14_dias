    ...
    <div className="w-full max-w-7xl mx-auto p-6 md:p-8 space-y-8 pb-12">
      ...
      {(() => {
        ...
        const textMessage = language === "en"
          ? `Hello! I invite you to join the team on Micro-Apps Portal as ${inviteRole}. Register using this link: ${generatedLink}`
          : `¡Hola! Te invito a unirte al equipo en Micro-Apps Portal como ${inviteRole}. Regístrate usando este enlace: ${generatedLink}`;
        ...
        const telegramUrl = `https://t.me/share/url?url=${encodedUrl}&text=${encodeURIComponent(
          language === "en" ? `Join the team as ${inviteRole}:` : `Únete al equipo como ${inviteRole}:`
        )}`;
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md">
            <GlassCard className="w-full max-w-md p-6 sm:p-8 relative animate-fade-in">
              ...
              <p className="text-xs text-base-content/60 mb-6 leading-relaxed">
                {language === "en"
                  ? "The invitation email was triggered. You can also share the link directly via other channels:"
                  : "Se ha solicitado el envío del correo de invitación. También puedes compartir el enlace directamente por otros canales:"}
              </p>

              {/* Social Sharing Buttons */}
              <div className="mb-6">
                <p className="block text-[10px] font-semibold text-base-content/40 uppercase tracking-widest mb-3 text-center">
                  {language === "en" ? "Share via Social Networks" : "Compartir por Redes Sociales"}
                </p>
                <div className="flex justify-center gap-4">
                  ...
                  <a
                    ...
                    className="flex items-center justify-center w-12 h-12 rounded-xl bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 transition-all duration-300 border border-[#25D366]/20 hover:shadow-[0_0_15px_rgba(37,211,102,0.3)]"
                    title="WhatsApp"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center w-12 h-12 rounded-xl bg-[#0088cc]/10 text-[#0088cc] hover:bg-[#0088cc]/20 transition-all duration-300 border border-[#0088cc]/20 hover:shadow-[0_0_15px_rgba(0,136,204,0.3)]"
                    title="Telegram"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm5.56 8.61l-1.91 9c-.14.63-.51.79-1.04.49l-2.91-2.15-1.4 1.35c-.15.15-.28.28-.58.28l.2-2.94 5.35-4.83c.23-.21-.05-.32-.35-.12l-6.62 4.17-2.85-.89c-.62-.2-.63-.62.13-.91l11.13-4.29c.52-.19.97.12.82.91z"/>
                    </svg>
                  </a>
